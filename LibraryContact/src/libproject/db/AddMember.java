...
public class AddMember extends javax.swing.JFrame implements ActionListener{
		        ...
		        layout.setHorizontalGroup(
		            ...
		            .addGroup(layout.createSequentialGroup()
		                ...
		                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		                    ...
		                    .addComponent(jT18, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
		                    .addComponent(jT19, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
		        ...
		        layout.setVerticalGroup(
		            ...
		            .addGroup(layout.createSequentialGroup()
		                ...
		                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
			                    ...
			                    .addComponent(jT18, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE))
		                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
			                    .addComponent(jLabel19)
			                    .addComponent(jT19, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE))
...
//		        this.setVisible(true);
		   ...
		   public void actionPerformed(ActionEvent event) {
			   ...
			   Connection conn = null;
		 	   Statement stmt = null;
		 	   ResultSet rs;
			   String sql="insert into contact (first_name,middle_name,last_name) "
			   		+ "values ( '"+jT1.getText()+"','"+jT2.getText()+"','"+jT3.getText()+"')";
...
//					  String cont = "select contact_id first_name,middle_name,last_name from contact where first_name= '"
//					  +jT1.getText()+"' and last_name= '"+jT2.getText()+"'";
//					  
//					  rs=stmt.executeQuery(cont);
//					  
//					  Integer i = rs.getInt(1);
					 ...
					 if(rs.next()){
					  ...
					  if (!jT18.getText().isEmpty()  || jT18.getText() != "1900-01-01" ) {
					   
					   String sql6="insert into date (contact_id,date_type,date) VALUES ("
				  				+key+
				  				", 'Birth Date', '"+jT18.getText()+"')";
					  ...
					  if (!jT18.getText().isEmpty()  || jT18.getText() != "1900-01-01" ) {
					   ...
					   String sql7="insert into date (contact_id,date_type,date) VALUES ("
				  				+key+
				  				", 'Anniversary', '"+jT19.getText()+"')";
